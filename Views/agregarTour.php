      ...
      <div class="bg-white shadow rounded-lg d-block d-sm-flex">
                <div class="tab-content p-5 p-md-5" id="v-pills-tabContent">
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="" id="proveedor"
                                            name="proveedor" required>
                                    </div>

                                    <div class="form-group">
                                        <label>Actividad</label>
                                        <input type="text" class="form-control" value="" id="actividad"
                                            name="actividad" required>
                                    </div>

                                    <div class="form-group">
                                        <label>Direccion</label>
                                        <input type="text" class="form-control" value="" id="direccion"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="" id="provincia"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="" id="transporte"
                                            name="transporte" required>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="submit" class="btn btn-primary btn-block" id="btnAgregarTour"
                                    name="btnAgregarTour" value="Agregar" />
