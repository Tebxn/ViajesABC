    ...
    <section class="content-header">
      ...
      <div class="bg-white shadow rounded-lg d-block d-sm-flex">
                <div class="tab-content p-4 p-md-5" id="v-pills-tabContent">
                    ...
                    <div class="container">    
                    <h5 class="mb-4">¿Desea eliminar el siguiente usuario?</h5>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="submit" class="btn btn-primary btn-block" id="btnEliminarUsuario"
                                    name="btnEliminarUsuario" value="Eliminar" />
                            </div>
                        </div>
