      ...
      <div class="bg-white shadow rounded-lg d-block d-sm-flex">
                <div class="tab-content p-5 p-md-5" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
                        <h3 class="mb-4">Agregar transporte</h3>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="" id="telefono"
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="submit" class="btn btn-primary btn-block" id="btnAgregarTransporte"
                                    name="btnAgregarTransporte" value="Agregar" />
