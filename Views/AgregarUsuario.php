      ...
      <div class="bg-white shadow rounded-lg d-block d-sm-flex">
                <div class="tab-content p-5 p-md-5" id="v-pills-tabContent">
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" value="" id="tipo_usuario"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" value="" id="contrasena_confirma"
                                            name="contrasena_confirma" required>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <input type="submit" class="btn btn-primary btn-block" id="btnAgregarUsuario"
                                    name="btnAgregarUsuario" value="Agregar" />

                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <a class="btn btn-light" href="ProductosAdmin.php" role="button">Cancelar</a>
                            </div>
                        </div>
                    </div>
                    </form>
